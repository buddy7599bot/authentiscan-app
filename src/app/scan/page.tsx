    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold mb-2">Authenticate Watch</h1>
            <p className="text-[var(--foreground-secondary)]">Upload 1-10 photos for AI analysis</p>
          </div>
          <Link href="/dashboard" className="chrome-pill-button">
            Back to Dashboard
          </Link>
        </div>
        ...
        {!result ? (
          <>
            ...
            >
              ...
              <p className="text-[var(--foreground-secondary)]">or click to browse (max 10 images)</p>
            </div>

            {/* Photo Guide */}
            <div className="mt-6 liquid-glass-card rounded-xl p-4">
              <h3 className="font-medium mb-2">📋 Best Photos to Upload:</h3>
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-sm text-[var(--foreground-secondary)]">
            ...
            {images.length > 0 && (
              <div className="mt-6">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="font-medium">Uploaded Photos ({images.length}/10)</h3>
          ...
          <div className="space-y-6">
            ...
            <p className="text-center text-[var(--foreground-secondary)] text-sm">
              This is an AI assistance tool. Results should be used as guidance only.
